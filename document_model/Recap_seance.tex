...
\begin{minipage}[t]{0.65\textwidth}
    \boite{Informations sur la séance :}{
...
\boite{Description de la séance :}{

\textbf{Automatismes :} % Automatismes : ,


\textbf{Travail à faire pour la séance :} % travail_a_faire : ,


\textbf{Contenu :} % contenu_seance_resume : ,


\textbf{Travail à faire à l'issue de la séance :} % devoirs_prochaine : ,


\vspace{2cm}
}

\boite{Remarques sur la séance :}{
